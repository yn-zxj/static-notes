import{_ as e,r as o,o as p,c,e as s,i as n,f as l,a}from"./app-BhJnf_CU.js";const r={},i=a(`<h2 id="帮助命令" tabindex="-1"><a class="header-anchor" href="#帮助命令"><span>帮助命令</span></a></h2><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>systemctl start <span class="token function">docker</span> <span class="token comment"># 启动docker</span>
...
</code></pre></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> version  <span class="token comment"># 显示docker版本信息</span>
...
</code></pre></div>`,3),u=s("strong",null,"帮助命令地址",-1),k={href:"https://docs.docker.com/reference/",target:"_blank",rel:"noopener noreferrer"},d=a(`<h2 id="镜像的基本命令" tabindex="-1"><a class="header-anchor" href="#镜像的基本命令"><span>镜像的基本命令</span></a></h2><h3 id="docker-images" tabindex="-1"><a class="header-anchor" href="#docker-images"><span>docker images</span></a></h3><p><strong>作用</strong>：显示本地主机上的镜像</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker images [OPTIONS] [REPOSITORY[:TAG]]</span>
...
</code></pre></div><p><strong>解释</strong>：<br><code>REPOSITORY</code>：镜像的仓库源<br><code>TAG</code>：镜像的标签<br><code>IMAGE ID</code>：镜像的 ID<br><code>CREATED</code>：镜像的创建时间<br><code>SIZE</code>：镜像的大小</p><p><strong>可选项</strong>：<br><code>-a, --all</code>：列出所有镜像<br><code>-q, --quiet</code>：只显示镜像的 ID</p><h3 id="docker-search" tabindex="-1"><a class="header-anchor" href="#docker-search"><span>docker search</span></a></h3><p><strong>作用</strong>：搜索 Docker Hub 中的镜像</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker search [OPTIONS] TERM</span>
...
</code></pre></div><h3 id="docker-pull" tabindex="-1"><a class="header-anchor" href="#docker-pull"><span>docker pull</span></a></h3><p><strong>作用</strong>：从镜像仓库下载镜像</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker pull [OPTIONS] NAME[:TAG|@DIGEST]</span>
...
</code></pre></div><h3 id="docker-rmi" tabindex="-1"><a class="header-anchor" href="#docker-rmi"><span>docker rmi</span></a></h3><p><strong>作用</strong>：删除镜像</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker rmi [OPTIONS] IMAGE [IMAGE...]</span>
...
</code></pre></div><h2 id="容器的基本命令" tabindex="-1"><a class="header-anchor" href="#容器的基本命令"><span>容器的基本命令</span></a></h2><h3 id="docker-run" tabindex="-1"><a class="header-anchor" href="#docker-run"><span>docker run</span></a></h3><p><strong>作用</strong>：创建并启动一个容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> IMAGE <span class="token punctuation">[</span>COMMAND<span class="token punctuation">]</span> <span class="token punctuation">[</span>ARG<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><p><strong>参数说明</strong>：<br><code>--name=&quot;container_name&quot;</code>：容器名字<br><code>-d</code>：后台运行<br><code>-it</code>：使用交互方式运行，进入容器查看内容<br><code>-p</code>：指定容器的端口<br><code>-P</code>：随机指定端口<br><code>-v</code>：将我们主机的目录与容器内的目录进行映射<br><code>-e</code>：设置环境变量<br><code>--network=&quot;host&quot;</code>：将我们容器连接到主机上<br><code>--network=&quot;bridge&quot;</code>：桥接网络</p><h3 id="docker-ps" tabindex="-1"><a class="header-anchor" href="#docker-ps"><span>docker ps</span></a></h3><p><strong>作用</strong>：查看当前所有运行的容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">ps</span> <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span>
</code></pre></div><p><strong>参数说明</strong>：<br><code>-a</code>：显示所有的容器，包括未运行的<br><code>-l</code>：显示最近创建的容器<br><code>-n</code>：显示最近 n 个创建的容器<br><code>--no-trunc</code>：不截断输出<br><code>-q</code>：静默模式，只显示容器编号</p><div class="hint-container tip"><p class="hint-container-title">docker ps 发现容器停止了</p><p>常见的坑：docker 容器后台运行，必须有一个前台进程，否则会自动停止</p></div><h3 id="docker-rm" tabindex="-1"><a class="header-anchor" href="#docker-rm"><span>docker rm</span></a></h3><p><strong>作用</strong>：删除一个或多少容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">rm</span> <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER <span class="token punctuation">[</span>CONTAINER<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
...
</code></pre></div><p><strong>参数说明</strong>：<br><code>-f, --force</code>：强制删除正在运行的容器（使用 SIGKILL）<br><code>-l, --link</code>：删除指定的链接<br><code>-v, --volumes</code>：删除与容器关联的匿名卷</p><h3 id="docker-start" tabindex="-1"><a class="header-anchor" href="#docker-start"><span>docker start</span></a></h3><p><strong>作用</strong>：启动容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> start <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER <span class="token punctuation">[</span>CONTAINER<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><h3 id="docker-restart" tabindex="-1"><a class="header-anchor" href="#docker-restart"><span>docker restart</span></a></h3><p><strong>作用</strong>：重启容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> restart <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER <span class="token punctuation">[</span>CONTAINER<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><h3 id="docker-stop" tabindex="-1"><a class="header-anchor" href="#docker-stop"><span>docker stop</span></a></h3><p><strong>作用</strong>：停止容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> stop <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER <span class="token punctuation">[</span>CONTAINER<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><div class="hint-container tip"><p class="hint-container-title">退出容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">exit</span>         <span class="token comment"># 直接退出容器</span>
Ctr + P + Q  <span class="token comment"># 容器不停止退出</span>
</code></pre></div></div><h3 id="docker-kill" tabindex="-1"><a class="header-anchor" href="#docker-kill"><span>docker kill</span></a></h3><p><strong>作用</strong>：强制停止容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">kill</span> <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER <span class="token punctuation">[</span>CONTAINER<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><h2 id="其它命令" tabindex="-1"><a class="header-anchor" href="#其它命令"><span>其它命令</span></a></h2><h3 id="docker-logs" tabindex="-1"><a class="header-anchor" href="#docker-logs"><span>docker logs</span></a></h3><p><strong>作用</strong>：查看容器日志</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> logs <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER
...
</code></pre></div><p><strong>参数说明</strong>：<br><code>--details</code>：显示额外的日志详细信息<br><code>-f, --follow</code>：跟踪日志输出<br><code>--since string</code>：显示某个开始时间的所有日志(e.g. 2013-01-02T13:23:37Z or 42m for 42 minutes)<br><code>-n, --tail string</code>：仅列出最新 N 条容器日志<br><code>-t, --timestamps</code>：显示时间戳<br><code>--until string</code>：显示时间戳或相对时间戳之前的日志</p><h3 id="docker-top" tabindex="-1"><a class="header-anchor" href="#docker-top"><span>docker top</span></a></h3><p><strong>作用</strong>：查看容器中运行的进程</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">top</span> CONTAINER <span class="token punctuation">[</span>ps OPTIONS<span class="token punctuation">]</span>
...
</code></pre></div><h3 id="docker-inspect" tabindex="-1"><a class="header-anchor" href="#docker-inspect"><span>docker inspect</span></a></h3><p><strong>作用</strong>：查看容器/镜像的元数据</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> inspect <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> NAME<span class="token operator">|</span>ID <span class="token punctuation">[</span>NAME<span class="token operator">|</span>ID<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><p><strong>参数说明</strong>：<br><code>-f, --format string</code>：格式化输出（eg: json）<br><code>-s, --size</code>：如果类型为容器，则显示总文件大小<br><code>--type string</code>：返回指定类型的 JSON</p><details class="hint-container details"><summary>docker inspect 示例</summary><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>ubuntu@root:~$ <span class="token function">docker</span> inspect 80a11a64ffad
<span class="token punctuation">[</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre></div></details><h3 id="docker-attach" tabindex="-1"><a class="header-anchor" href="#docker-attach"><span>docker attach</span></a></h3><p><strong>作用</strong>：连接到正在运行中的容器</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> attach <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER
</code></pre></div><h3 id="docker-exec" tabindex="-1"><a class="header-anchor" href="#docker-exec"><span>docker exec</span></a></h3><p><strong>作用</strong>：在运行中的容器中执行命令</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> CONTAINER COMMAND <span class="token punctuation">[</span>ARG<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre></div><details class="hint-container details"><summary>示例</summary><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>ubuntu@root:~$ <span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> 185caa2b4f47 /bin/bash
 _   _       _            ____                      __  __
...
</code></pre></div></details><div class="hint-container tip"><p class="hint-container-title">docker attach 和 docker exec 的区别</p><p><code>docker exec</code>进入容器后开启一个新的终端，可以在里面操作(常用)<br><code>docker attach</code>进入容器正在执行的终端，不会启动新的进程(只是附着到容器上)</p><p>  如果 Docker 容器是使用<code>/bin/bash</code>命令启动的，则可以使用 attach 来访问它，如果不是，则需要在容器内创建一个 bash 实例。</p></div><h3 id="docker-cp" tabindex="-1"><a class="header-anchor" href="#docker-cp"><span>docker cp</span></a></h3><p><strong>作用</strong>：命令用于在容器和主机之间复制文件</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 复制文件到主机(docker cp container_id:src_path dest_path)</span>
...
</code></pre></div><details class="hint-container details"><summary>docker cp 示例</summary><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 主机复制文件进容器</span>
...
</code></pre></div></details>`,67);function m(b,g){const t=o("ExternalLinkIcon");return p(),c("div",null,[i,s("p",null,[u,n("："),s("a",k,[n("https://docs.docker.com/reference/"),l(t)])]),d])}const f=e(r,[["render",m],["__file","basic.html.vue"]]),q=JSON.parse('{"path":"/backend/docker/basic.html","title":"基本命令","lang":"zh-CN","frontmatter":{"title":"基本命令","icon":"structure","order":1,"author":"Mr.Zhang","category":["后端"],"tag":["Docker"],"date":"2024-01-25T00:00:00.000Z","description":"帮助命令 帮助命令地址：https://docs.docker.com/reference/ 镜像的基本命令 docker images 作用：显示本地主机上的镜像 解释： REPOSITORY：镜像的仓库源 TAG：镜像的标签 IMAGE ID：镜像的 ID CREATED：镜像的创建时间 SIZE：镜像的大小 可选项： -a, --all：列出所有...","head":[["meta",{"property":"og:url","content":"https://doc.bt66.cn/backend/docker/basic.html"}],["meta",{"property":"og:title","content":"基本命令"}],["meta",{"property":"og:description","content":"帮助命令 帮助命令地址：https://docs.docker.com/reference/ 镜像的基本命令 docker images 作用：显示本地主机上的镜像 解释： REPOSITORY：镜像的仓库源 TAG：镜像的标签 IMAGE ID：镜像的 ID CREATED：镜像的创建时间 SIZE：镜像的大小 可选项： -a, --all：列出所有..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-28T15:12:11.000Z"}],["meta",{"property":"article:author","content":"Mr.Zhang"}],["meta",{"property":"article:tag","content":"Docker"}],["meta",{"property":"article:published_time","content":"2024-01-25T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-01-28T15:12:11.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"基本命令\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-01-25T00:00:00.000Z\\",\\"dateModified\\":\\"2024-01-28T15:12:11.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Mr.Zhang\\"}]}"]]},"headers":[{"level":2,"title":"帮助命令","slug":"帮助命令","link":"#帮助命令","children":[]},{"level":2,"title":"镜像的基本命令","slug":"镜像的基本命令","link":"#镜像的基本命令","children":[{"level":3,"title":"docker images","slug":"docker-images","link":"#docker-images","children":[]},{"level":3,"title":"docker search","slug":"docker-search","link":"#docker-search","children":[]},{"level":3,"title":"docker pull","slug":"docker-pull","link":"#docker-pull","children":[]},{"level":3,"title":"docker rmi","slug":"docker-rmi","link":"#docker-rmi","children":[]}]},{"level":2,"title":"容器的基本命令","slug":"容器的基本命令","link":"#容器的基本命令","children":[{"level":3,"title":"docker run","slug":"docker-run","link":"#docker-run","children":[]},{"level":3,"title":"docker ps","slug":"docker-ps","link":"#docker-ps","children":[]},{"level":3,"title":"docker rm","slug":"docker-rm","link":"#docker-rm","children":[]},{"level":3,"title":"docker start","slug":"docker-start","link":"#docker-start","children":[]},{"level":3,"title":"docker restart","slug":"docker-restart","link":"#docker-restart","children":[]},{"level":3,"title":"docker stop","slug":"docker-stop","link":"#docker-stop","children":[]},{"level":3,"title":"docker kill","slug":"docker-kill","link":"#docker-kill","children":[]}]},{"level":2,"title":"其它命令","slug":"其它命令","link":"#其它命令","children":[{"level":3,"title":"docker logs","slug":"docker-logs","link":"#docker-logs","children":[]},{"level":3,"title":"docker top","slug":"docker-top","link":"#docker-top","children":[]},{"level":3,"title":"docker inspect","slug":"docker-inspect","link":"#docker-inspect","children":[]},{"level":3,"title":"docker attach","slug":"docker-attach","link":"#docker-attach","children":[]},{"level":3,"title":"docker exec","slug":"docker-exec","link":"#docker-exec","children":[]},{"level":3,"title":"docker cp","slug":"docker-cp","link":"#docker-cp","children":[]}]}],"git":{"createdTime":1706196688000,"updatedTime":1706454731000,"contributors":[{"name":"ynzxj","email":"ynzxj@qq.com","commits":2}]},"readingTime":{"minutes":6.54,"words":1963},"filePathRelative":"backend/docker/basic.md","localizedDate":"2024年1月25日","autoDesc":true}');export{f as comp,q as data};
