import{_ as a,M as n,Y as s,a2 as e}from"./framework-0d8205ef.js";const t={},p=e(`<h2 id="git-基本配置" tabindex="-1"><a class="header-anchor" href="#git-基本配置" aria-hidden="true">#</a> git 基本配置</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 生成密钥对</span>
