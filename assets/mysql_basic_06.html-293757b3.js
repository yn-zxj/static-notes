...
</code></pre></div><p>  在 SQL 语句中的<code>WHERE</code>子句里，用<code>AND</code>将两个连接条件结合起来，像这样的连接称为多表的等值查询。其核心表是<code>table1</code>，分别通过<code>column1</code>与表<code>table2</code>关联，通过<code>column2</code>与表<code>table3</code>关联。</p><h3 id="_2-3-非等值连接" tabindex="-1"><a class="header-anchor" href="#_2-3-非等值连接" aria-hidden="true">#</a> 2.3 非等值连接</h3><figure><img src="http://doc-img.bt66.cn/img/data_of_table.png" alt="表数据.png" tabindex="0" loading="lazy"><figcaption>表数据.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
...
</code></pre></div><blockquote><p>左表匹配数据全部展示，右表不匹配的数据展示为 NULL</p></blockquote><figure><img src="http://doc-img.bt66.cn/img/left_join.png" alt="左外连接.png" width="250" tabindex="0" loading="lazy"><figcaption>左外连接.png</figcaption></figure><h3 id="_6-2-右外连接" tabindex="-1"><a class="header-anchor" href="#_6-2-右外连接" aria-hidden="true">#</a> 6.2 右外连接</h3><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token comment">/*
说明：employees 共107条记录，其中last_name = &#39;Grant&#39;的员工没有部门
...
</code></pre></div><blockquote><p>右表匹配数据全部展示，左表不匹配的数据展示为 NULL</p></blockquote><figure><img src="http://doc-img.bt66.cn/img/right_join.png" alt="右外连接.png" width="250" tabindex="0" loading="lazy"><figcaption>右外连接.png</figcaption></figure><div class="hint-container tip"><p class="hint-container-title">提示</p><p>① <code>OUTER</code>可以省略！</p><p>② 有相同的字段名且字段的数据类型相同可以使用<code>USING</code>子句。</p></div><h2 id="_7-union-的使用" tabindex="-1"><a class="header-anchor" href="#_7-union-的使用" aria-hidden="true">#</a> 7.UNION 的使用</h2><p>合并查询结果利用 UNION 关键字，可以给出多条 SELECT 语句，并将它们的结果组合成单个结果集。合并时，两个表对应的列数和数据类型必须相同，并且相互对应。各个 SELECT 语句之间使用 UNION 或 UNION ALL 关键字分隔。</p><p><strong>语法格式</strong>：</p><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span> <span class="token keyword">column</span><span class="token punctuation">,</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span> <span class="token keyword">FROM</span> <span class="token keyword">table</span>
...
</code></pre></div><table><thead><tr><th>UNION</th><th>UNION ALL</th></tr></thead><tbody><tr><td><img src="http://doc-img.bt66.cn/img/union.png"></td><td><img src="http://doc-img.bt66.cn/img/union_all.png"></td></tr><tr><td>返回两个查询的结果集的并集，去除重复记录</td><td>返回两个查询的结果集的并集，不去除重复记录</td></tr></tbody></table><div class="hint-container warning"><p class="hint-container-title">注意</p><p>执行 UNION ALL 语句时所需要的资源比 UNION 语句少。如果明确知道合并数据后的结果数据不存在重复数据，或者不需要去除重复的数据，则尽量使用 UNION ALL 语句，以提高数据查询的效率。</p></div><h2 id="_8-sql-joins-总结" tabindex="-1"><a class="header-anchor" href="#_8-sql-joins-总结" aria-hidden="true">#</a> 8.SQL JOINS(总结)</h2><p>假设有<code>TableA</code>和<code>TableB</code>两张表，示例数据如下图所示，且红色高亮部分表示两个表的匹配数据。</p>`,49),k={href:"https://learnsql.com/blog/sql-joins/",target:"_blank",rel:"noopener noreferrer"},r=s(`<details class="hint-container details"><summary>测试数据</summary><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">DROP</span> <span class="token keyword">TABLE</span> <span class="token keyword">IF</span> <span class="token keyword">EXISTS</span> <span class="token identifier"><span class="token punctuation">\`</span>TableA<span class="token punctuation">\`</span></span><span class="token punctuation">;</span>
...
</code></pre></div></details><figure><img src="http://doc-img.bt66.cn/img/demo_data.png" alt="演示数据.png" tabindex="0" loading="lazy"><figcaption>演示数据.png</figcaption></figure><h3 id="_8-1-交叉连接" tabindex="-1"><a class="header-anchor" href="#_8-1-交叉连接" aria-hidden="true">#</a> 8.1 交叉连接</h3><figure><img src="http://doc-img.bt66.cn/img/cross_join.png" alt="交叉连接.png" tabindex="0" loading="lazy"><figcaption>交叉连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
...
</code></pre></div><h3 id="_8-2-内连接" tabindex="-1"><a class="header-anchor" href="#_8-2-内连接" aria-hidden="true">#</a> 8.2 内连接</h3><figure><img src="http://doc-img.bt66.cn/img/inner_join.png" alt="内连接.png" tabindex="0" loading="lazy"><figcaption>内连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><h3 id="_8-3-左外连接" tabindex="-1"><a class="header-anchor" href="#_8-3-左外连接" aria-hidden="true">#</a> 8.3 左外连接</h3><figure><img src="http://doc-img.bt66.cn/img/left_outer_join.png" alt="左外连接.png" tabindex="0" loading="lazy"><figcaption>左外连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><h3 id="_8-4-右外连接" tabindex="-1"><a class="header-anchor" href="#_8-4-右外连接" aria-hidden="true">#</a> 8.4 右外连接</h3><figure><img src="http://doc-img.bt66.cn/img/right_outer_join.png" alt="右外连接.png" tabindex="0" loading="lazy"><figcaption>右外连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><h3 id="_8-5-左排除外连接-左表唯一" tabindex="-1"><a class="header-anchor" href="#_8-5-左排除外连接-左表唯一" aria-hidden="true">#</a> 8.5 左排除外连接(左表唯一)</h3><figure><img src="http://doc-img.bt66.cn/img/left_excluding_join.png" alt="左排除外连接.png" tabindex="0" loading="lazy"><figcaption>左排除外连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><blockquote><p>相当于左外连接去除两表匹配部分，剩下的为左表与右表不匹配的数据，而这些数据由于不匹配的缘故，右表不存在则展示为<code>null</code></p></blockquote><h3 id="_8-6-右排除外连接-右表唯一" tabindex="-1"><a class="header-anchor" href="#_8-6-右排除外连接-右表唯一" aria-hidden="true">#</a> 8.6 右排除外连接(右表唯一)</h3><figure><img src="http://doc-img.bt66.cn/img/right_excluding_join.png" alt="右排除外连接.png" tabindex="0" loading="lazy"><figcaption>右排除外连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><blockquote><p>相当于右外连接去除两表匹配部分，剩下的为左表与右表不匹配的数据，而这些数据由于不匹配的缘故，左表不存在则展示为<code>null</code></p></blockquote><h3 id="_8-7-全外连接" tabindex="-1"><a class="header-anchor" href="#_8-7-全外连接" aria-hidden="true">#</a> 8.7 全外连接</h3><figure><img src="http://doc-img.bt66.cn/img/full_outer_join.png" alt="全外连接.png" tabindex="0" loading="lazy"><figcaption>全外连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><h3 id="_8-8-非交集连接" tabindex="-1"><a class="header-anchor" href="#_8-8-非交集连接" aria-hidden="true">#</a> 8.8 非交集连接</h3><figure><img src="http://doc-img.bt66.cn/img/out_excluding_join.png" alt="非交集连接.png" tabindex="0" loading="lazy"><figcaption>非交集连接.png</figcaption></figure><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
  a<span class="token punctuation">.</span>a_id<span class="token punctuation">,</span> a<span class="token punctuation">.</span>name <span class="token string">&#39;a_name&#39;</span><span class="token punctuation">,</span> b<span class="token punctuation">.</span>b_id<span class="token punctuation">,</span> b<span class="token punctuation">.</span>name <span class="token string">&#39;b_name&#39;</span>
<span class="token keyword">FROM</span>
  tableA a
...
</code></pre></div><blockquote><p>相当于全外连接去除两表匹配部分，剩下的为左表与右表不匹配的数据，而这些数据由于不匹配的缘故，左表或右表中不存在则展示为<code>null</code></p></blockquote><div class="hint-container warning"><p class="hint-container-title">注意</p><p>我们要控制连接表的数量。多表连接就相当于嵌套 for 循环一样，非常消耗资源，会让 SQL 查询性能下降得很严重，因此不要连接不必要的表。在许多 DBMS 中，也都会有最大连接表的限制。</p><blockquote><p>【强制】超过三个表禁止 join。需要 join 的字段，数据类型保持绝对一致；多表关联查询时， 保证被关联的字段需要有索引。<br> 说明：即使双表 join 也要注意表索引、SQL 性能。<br> 来源：阿里巴巴《Java 开发手册》</p></blockquote></div><h3 id="_8-9-附图-sql-joins" tabindex="-1"><a class="header-anchor" href="#_8-9-附图-sql-joins" aria-hidden="true">#</a> 8.9 附图 SQL JOINS</h3><figure><img src="http://doc-img.bt66.cn/img/sql_joins.png" alt="SQL_JOINS.png" width="500" tabindex="0" loading="lazy"><figcaption>SQL_JOINS.png</figcaption></figure>`,32);function d(g,m){const t=l("ExternalLinkIcon");return e(),o("div",null,[u,n("p",null,[a("参考地址："),n("a",k,[a("https://learnsql.com/blog/sql-joins/"),c(t)])]),r])}const y=p(i,[["render",d],["__file","mysql_basic_06.html.vue"]]);export{y as default};
