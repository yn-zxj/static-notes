import{_ as t,M as o,Y as c,a0 as a,a1 as n,Z as p,a2 as s,C as r}from"./framework-0d8205ef.js";const l="/assets/source_download-03284ebf.png",i="/assets/problem_of_8-7bbe9600.png",d="/assets/auth_method_of_8-642ec071.png",h={},u=s(`<h2 id="_1-安装与卸载" tabindex="-1"><a class="header-anchor" href="#_1-安装与卸载" aria-hidden="true">#</a> 1.安装与卸载</h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p>请自行百度！</p></div><h2 id="_2-初识-mysql" tabindex="-1"><a class="header-anchor" href="#_2-初识-mysql" aria-hidden="true">#</a> 2.初识 MySQL</h2><h3 id="_2-1-服务的启动与停止" tabindex="-1"><a class="header-anchor" href="#_2-1-服务的启动与停止" aria-hidden="true">#</a> 2.1 服务的启动与停止</h3><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 启动 MySQL 服务命令</span>
net start MySQL服务名
...
</code></pre></div>`,14);function k(b,_){const e=r("ExternalLinkIcon");return o(),c("div",null,[u,a("p",null,[n("下载地址："),a("a",m,[n("https://downloads.mysql.com/archives/community/"),p(e)])]),g])}const v=t(h,[["render",k],["__file","environment_building.html.vue"]]);export{v as default};
