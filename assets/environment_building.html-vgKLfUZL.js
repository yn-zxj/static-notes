import{_ as t,l as o,o as c,c as p,g as a,k as n,i as r,a as s}from"./app-udH3LXWk.js";const l="/assets/source_download-GwpmcfS2.png",i="/assets/problem_of_8-lA3FjhaG.png",d="/assets/auth_method_of_8--2-NI5FQ.png",h={},u=s(`<h2 id="安装与卸载" tabindex="-1"><a class="header-anchor" href="#安装与卸载" aria-hidden="true">#</a> 安装与卸载</h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p>请自行百度！</p></div><h2 id="初识-mysql" tabindex="-1"><a class="header-anchor" href="#初识-mysql" aria-hidden="true">#</a> 初识 MySQL</h2><h3 id="服务的启动与停止" tabindex="-1"><a class="header-anchor" href="#服务的启动与停止" aria-hidden="true">#</a> 服务的启动与停止</h3><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 启动 MySQL 服务命令</span>
net start MySQL服务名
