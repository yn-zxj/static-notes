import{_ as l,j as u,o as i,c as r,f as n,g as p,w as a,a as o,i as s}from"./app-c0e69fbc.js";const k="/assets/reflect_to_do-0b16474d.png",d={},m=o('<h2 id="反射的概述" tabindex="-1"><a class="header-anchor" href="#反射的概述" aria-hidden="true">#</a> 反射的概述</h2><p>  在 Java 中的反射机制是指在运行状态中，对于任意一个类都能够知道这个类所有的属性和方法；并且对于任意一个对象，都能够调用它的任意一个方法；这种动态获取信息以及动态调用对象方法的功能称为 Java 语言的反射机制。</p><blockquote><p>反射允许对封装类的字段、方法和构造函数的信息进行编程访问。</p><figure><img src="'+k+`" alt="反射能干的事.png" width="600" tabindex="0" loading="lazy"><figcaption>反射能干的事.png</figcaption></figure></blockquote><h2 id="反射机制的相关类在哪个包下" tabindex="-1"><a class="header-anchor" href="#反射机制的相关类在哪个包下" aria-hidden="true">#</a> 反射机制的相关类在哪个包下？</h2><p><code>java.lang.reflect.*;</code></p><hr><details class="hint-container details"><summary>演示用的 Person 类</summary><div class="language-java" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>test<span class="token punctuation">.</span>reflect</span><span class="token punctuation">;</span>
